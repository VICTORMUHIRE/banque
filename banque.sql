...
-- Listage de la structure de la base pour banque
...
-- Listage de la structure de table banque. client
...
-- Listage des données de la table banque.client : ~2 rows (environ)
INSERT INTO `client` (`id`, `nom`, `pasword`, `solde`) VALUES
	(4, 'george', 'george@23', 123.00),
	(5, 'enock', '@enock', 60.00),
	(8, 'ben', '@ben', 20.00);
